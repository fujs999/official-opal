...
public class OpalMessage : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(OpalMessage obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public ulong enqueueTime {
    set {
      OPALPINVOKE.OpalMessage_enqueueTime_set(swigCPtr, value);
    } 
    get {
      ulong ret = OPALPINVOKE.OpalMessage_enqueueTime_get(swigCPtr);
      return ret;
    } 
  }
